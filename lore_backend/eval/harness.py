...
what makes the two comparable: same questions, same store, same scoring.
    ...
    python -m lore_backend.eval.harness --compare    # agent vs pipeline, side by side
...
from lore_backend.eval.golden_set import GOLDEN_SET, GoldenCase
from lore_backend.eval.judge import UNAVAILABLE, Verdict, judge
